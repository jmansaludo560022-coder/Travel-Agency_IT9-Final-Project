...
<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-0.5">{{ $payments->total() }} active payment records</p>
        </div>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            <a href="{{ route('agent.payments.show', $payment->id) }}"
                                class="text-xs text-sky-600 dark:text-sky-400 hover:underline">View</a>
                            <form action="{{ route('agent.payments.archive', $payment->id) }}" method="POST" class="inline"
