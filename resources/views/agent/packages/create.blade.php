...
<div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
        ...
        <p class="text-xs text-gray-500 mt-0.5">Package will be submitted for admin approval before becoming visible</p>
    </div>
    <form action="{{ route('agent.packages.store') }}" method="POST" class="p-6 space-y-5">
        @csrf
        @php
        ...
        <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-200 dark:border-gray-800">
            ...
            <button type="submit" class="px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white text-sm font-semibold rounded-lg transition">Submit for Approval</button>
        </div>
    </form>
</div>
</div>
