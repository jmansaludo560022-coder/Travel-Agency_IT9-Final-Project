...
class PaymentController extends Controller
{
    ...
    public function create()
    {
        ...
        // All bookings with outstanding balance
        ...
        return view('agent.payments.create', compact('bookings', 'booking', 'balance'));
    }
    ...
    public function store(StorePaymentRequest $request)
    {
        ...
        return redirect()->route('agent.payments.show', $payment->id)
            ->with('success', 'Payment recorded successfully. Awaiting admin verification.');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('agent.payments.archived')->with('success', 'Payment restored.');
    }
    ...
    public function archived()
    {
        ...
        return view('agent.payments.archived', compact('payments'));
    }
}
